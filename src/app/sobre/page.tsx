...
export const metadata: Metadata = {
  title: "Sobre a Juliana Present | Juliana Present",
  description:
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      >
        ...
        <span className="text-foreground">Sobre a Juliana Present</span>
      </nav>

      <h1 className="mt-4 font-display text-3xl text-foreground md:text-4xl">
        Sobre a Juliana Present
      </h1>
      ...
      <p className="mt-4 text-muted-foreground">
        A Juliana Present monta cestas de café da manhã e presentes afetivos
