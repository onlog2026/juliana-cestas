...
/**
 * Formulário de "definir nova senha". Ficava dentro de
 * `app/redefinir-senha/page.tsx`; saiu de lá só para a página poder ser server
 * component e descobrir o nome da loja pelo endereço acessado. O fluxo de
 * troca de senha é exatamente o mesmo.
 */
