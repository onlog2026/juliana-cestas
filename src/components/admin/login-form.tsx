...
/**
 * Formulário de login do painel. Ficava dentro de `app/admin/login/page.tsx`;
 * saiu de lá só para a página poder ser server component e descobrir o nome da
 * loja pelo endereço acessado. O comportamento do login é exatamente o mesmo.
 */
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-secondary/40 px-4">
      <div className="w-full max-w-sm rounded-card border border-border bg-card p-8">
        {storeName ? <p className="font-display text-2xl text-primary">{storeName}</p> : null}
        <h1 className="mt-1 text-lg font-semibold text-foreground">
          {storeName ? "Painel de gestão" : "Acessar o painel"}
        </h1>
